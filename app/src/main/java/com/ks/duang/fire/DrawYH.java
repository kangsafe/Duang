...
public class DrawYH extends DrawTopBase {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        bgMedia.playInMediaPlayer(R.raw.fire_start, null);
    }
    ...
    private int id_sound1 = R.raw.fire_start;
    private int id_sound2 = R.raw.fire_end;
    GameSoundMedia bgMedia;

    public void init() {
        soundPool = new GameSoundPool(mContext);
        // Log.i("gary", mContext.toString());
        soundPool.loadSfx(R.raw.fire_start, id_sound1);
        soundPool.loadSfx(R.raw.fire_end, id_sound2);
